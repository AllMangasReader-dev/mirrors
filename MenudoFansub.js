var MenudoFansub = {
	mirrorName : "MenudoFansub",
	canListFullMangas : false,
	mirrorIcon : "img/menudofansub.png",
	languages : "es",
	isMe : function (url) {
		return (url.indexOf("menudo-fansub.com/slide/") != -1);
	},
	getMangaList : function (search, callback) {
		$.ajax({
			url : "http://menudo-fansub.com/slide/reader/search/",
			type : 'POST',
			data : {
				'search' : search
			},
	...
	isCurrentPageAChapterPage : function (doc, curUrl) {
		return (curUrl.search('menudo-fansub.com/slide/reader/read/') > -1);
	},
