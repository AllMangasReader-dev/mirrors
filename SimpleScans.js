...
var SimpleScans = {
  ...
  isMe : function(url) {
    return (url.indexOf("www.simple-scans.com/slide/") != -1);
  },
  ...
  getMangaList : function(search, callback) {
     $.ajax(
        {
          //CHANGE URL HERE
          url: "http://www.simple-scans.com/slide/reader/search/",
		  type: 'POST',
		  data:
		  {
			'search': search
  ...
  ********************************************************************************************************/
  ...
  isCurrentPageAChapterPage : function(doc, curUrl) {
    return (curUrl.search('www.simple-scans.com/slide/reader/read/') > -1);
  },
