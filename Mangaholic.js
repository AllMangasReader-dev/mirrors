var Mangaholic = {
	mirrorName : "Mangaholic",
	canListFullMangas : false,
	mirrorIcon : "img/Mangaholic.png",
	languages : "en",
	isMe : function (url) {
		return (url.indexOf("mangaholic.tk/slide") != -1);
	},
	getMangaList : function (search, callback) {
		$.ajax({
			url : "http://mangaholic.tk/slide/reader/search/",
			type : 'POST',
			data : {
				'search' : search
			},
	...
	isCurrentPageAChapterPage : function (doc, curUrl) {
		return (curUrl.search('mangaholic.tk/slide/reader/read/') > -1);
	},
