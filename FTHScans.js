var FTHScans = {
   mirrorName : "For The Halibut",
   canListFullMangas : false,
   mirrorIcon : "img/fthscans.png",
   languages : "en",
   isMe : function (url) {
      return (url.indexOf("reader.fth-scans.com/") != -1);
   },
   getMangaList : function (search, callback) {
      $.ajax({
         url : "http://reader.fth-scans.com/reader/search/",
         type : 'POST',
         data : {
            'search' : search
         },
   ...
   isCurrentPageAChapterPage : function (doc, curUrl) {
      return (curUrl.search('reader.fth-scans.com/reader/read/') > -1);
   },
