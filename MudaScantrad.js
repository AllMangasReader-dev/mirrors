var MudaScantrad = {
  mirrorName : "Muda Scantrad",
  canListFullMangas : false,
  mirrorIcon : "img/generic.png",
  languages : "en",
  isMe : function (url) {
    return (url.indexOf("www.mudascantrad.com/MudaReader") != -1);
  },
  getMangaList : function (search, callback) {
    $.ajax({
      url : "http://www.mudascantrad.com/MudaReader/reader/search/",
      type : 'POST',
      data : {
        'search' : search
      },
  ...
  isCurrentPageAChapterPage : function (doc, curUrl) {
    return (curUrl.search('www.mudascantrad.com/MudaReader/reader/read/') > -1);
  },
